...
if __name__ == '__main__':
    ...
    print("is active:", gripper.is_active())

    start = time.time()
    gripper.move_and_wait_for_pos(position, 50, 20)
    print("gripper set cost time: {}".format(time.time() - start))
    print("gripper move finish")